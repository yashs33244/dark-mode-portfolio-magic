  ...
  const projects = [
    {
      title: "FinalCV.com",
      description:
        "AI-powered resume builder trusted by professionals from Flipkart, Uber, Amazon",
      stack:
        "Next.js, TypeScript, Prisma, PostgreSQL, Docker, Turborepo, Recoil, Gemini API",
    ...
    },
    {
      ...
      description:
        "Enterprise-level surveillance system with real-time monitoring and AI capabilities",
    ...
    },
    {
      title: "IIITU-Today",
      description:
        "Campus-wide social media platform with optimized performance",
      stack: "Next.js, Prisma, PostgreSQL, Redis, Tailwind CSS",
      liveLink: "https://iiituchat.yashprojects.online",
      github: "https://github.com/yashs33244/iiitu-today.git",
      metrics: [
